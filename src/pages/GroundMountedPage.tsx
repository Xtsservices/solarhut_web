...
export function GroundMountedPage() {
  ...
  return (
    <div className="min-h-screen" style={{ backgroundColor: '#FEF7ED' }}>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {specifications.map((spec, index) => (
              <Card key={index} className="text-center border-0 shadow-lg hover:shadow-xl transition-shadow">
                <CardContent className="pt-6">
                  <div className="text-3xl font-bold text-[#FFA500] mb-2">{spec.value}</div>
                  <div className="text-lg font-semibold text-gray-900 mb-1">{spec.label}</div>
                  <div className="text-sm text-gray-600">{spec.description}</div>
                </CardContent>
              </Card>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid lg:grid-cols-2 gap-12">
            <Card className="p-8 border-0 shadow-xl bg-gradient-to-br from-blue-50 to-blue-100">
              <CardContent className="pt-0">
                <h3 className="text-2xl font-bold text-gray-900 mb-6">Benefits of Ground Mount</h3>
                <ul className="space-y-3">
                  {[
      ...
      {/* CTA Section */}
      <section className="py-16 bg-[#FFF7ED] text-black">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-4xl font-bold mb-4">Have Land? Let's Build Your Solar Future</h2>
          <p className="text-xl mb-8">
            ...
            <Button
              size="lg"
              className="bg-white text-[#FFF7ED] hover:bg-gray-100"
            >
              Schedule Land Assessment
            </Button>
            <Button
              size="lg"
              variant="outline"
              className="border-[#2563eb] text-[#FFF7ED] hover:bg-[#2563eb] hover:text-[#FFF7ED]"
            >
              Get Feasibility Study
            </Button>
            </div>
