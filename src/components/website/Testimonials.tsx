...
import { Star, Quote, MapPin, IndianRupee, Calendar } from "lucide-react";
...
export function Testimonials({ onNavigate }: TestimonialsProps) {
  ...
  const stats = [
    ...
    { label: "Average Savings", value: "₹85,000", icon: IndianRupee },
  ...
  return (
    <section id="testimonials" className="section-testimonials section-padding">
      <div className="section-container">
        ...
        <div className="mb-8 sm:mb-12 lg:mb-16">
          <div className="hidden sm:grid grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
            {stats.map((stat, index) => (
              <div key={index} className="text-center p-4 sm:p-6 bg-gradient-to-br from-orange-50 to-amber-50 rounded-xl">
          ...
          <div className="sm:hidden overflow-x-auto scrollbar-hide -mx-4 px-4">
            <div className="flex gap-4 pb-4" style={{ scrollSnapType: 'x mandatory' }}>
              {stats.map((stat, index) => (
                <div key={index} className="text-center p-4 bg-gradient-to-br from-orange-50 to-amber-50 rounded-xl flex-shrink-0 w-[160px]" style={{ scrollSnapAlign: 'start' }}>
        ...
        {/* <div className="mb-16">
          <h3 className="text-2xl text-gray-900 mb-8 text-center">Featured Customer Stories</h3>
                ...
                <CardContent className="p-6">
                  ...
                  <div className="space-y-2 pt-4 border-t border-gray-200">
                    ...
                    <div className="flex justify-between items-center text-sm">
                      ...
                      <span className="text-accent">{testimonial.savings}</span>
                    </div>
                    <div className="flex justify-between items-center text-sm">
        ...
        {/* Additional Testimonials - Scrollable on Mobile */}
                ...
                <CardContent className="p-6">
                  <div className="flex items-center space-x-3 mb-3">
                    <Avatar className="w-10 h-10">
                      <AvatarFallback className="bg-[#FFA500] text-white text-sm">
                        {testimonial.avatar}
                      </AvatarFallback>
                    </Avatar>
                    <div>
                  ...
                  <div className="flex justify-between items-center text-xs text-gray-500 pt-3 border-t border-gray-100">
                    ...
                    <span className="text-[#FFA500]">{testimonial.savings}</span>
                  </div>
                </CardContent>
              </Card>
            ))}
                  ...
                  <CardContent className="p-5">
                    <div className="flex items-center space-x-3 mb-3">
                      ...
                      <div className="min-w-0 flex-1">
                        <h5 className="text-gray-900 text-sm truncate">{testimonial.name}</h5>
                    ...
                    <blockquote className="text-sm text-gray-700 mb-3 leading-relaxed line-clamp-4">
                      "{testimonial.quote}"
                    </blockquote>

                    <div className="flex justify-between items-center text-xs text-gray-500 pt-3 border-t border-gray-100">
                      <span className="truncate">{testimonial.system}</span>
                      <span className="text-[#FFA500] flex-shrink-0 ml-2">{testimonial.savings}</span>
                    </div>
                  </CardContent>
                </Card>
              ))}
        ...
        <div className="text-center bg-gradient-to-r from-orange-50 to-amber-50 p-8 rounded-2xl">
          <div className="max-w-2xl mx-auto">
            ...
            <p className="text-gray-600 mb-6">
              Watch video testimonials and read detailed case studies from our satisfied customers across India.
            </p>
