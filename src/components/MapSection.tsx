              ...
              <div className="relative w-full h-64 sm:h-80 lg:h-96 bg-gray-100 rounded-lg overflow-hidden">
                ...
                */}
                ...
                <div style={{ marginTop: "15rem" }}>
                  <div className="absolute top-8 left-4 sm:top-8 sm:left-8 mt-4 sm:mt-8 bg-white/95 backdrop-blur-sm p-3 sm:p-4 rounded-lg shadow-lg max-w-xs sm:max-w-xs z-20">
