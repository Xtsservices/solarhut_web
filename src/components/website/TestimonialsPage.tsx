    ...
    <div className="min-h-screen" style={{ backgroundColor: '#FEF7ED' }}>
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="text-lg md:text-xl text-gray-600 max-w-3xl mx-auto">
              Hear from our satisfied customers who have transformed their lives with solar energy. Real stories, real savings, real impact.
            </p>
          </div>
        </div>
      </section>
                    ...
                    <Card key={testimonial.id} className="border-0 shadow-lg hover:shadow-xl transition-shadow">
                      <CardContent className="p-6">
                        ...
                        <div className="grid grid-cols-3 gap-4 p-4 bg-gray-50 rounded-lg">
                          <div className="text-center">
                            <div className="text-lg text-[#FFA500]">{testimonial.systemSize}</div>
                            <div className="text-sm text-gray-600">System Size</div>
                          </div>
                          <div className="text-center">
                            <div className="text-lg text-[#2D8A47]">{testimonial.savings}</div>
      ...
      <section className="py-16 bg-[#FEF7ED] text-black">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-4xl text-black mb-4">Ready to Share Your Success Story?</h2>
