...
// Vite-resolvable hero image to ensure correct bundling and responsive loading
const heroImg = new URL("../assets/SolarHutImages/solar4.jpeg", import.meta.url).href;

export function Hero() {
  return (
    <section id="home" className="section-hero py-12">
      <div className="section-container">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
          ...
          <div className="relative">
            <ImageWithFallback
              ...
              className="w-full max-w-full h-64 sm:h-80 md:h-96 lg:h-[600px] object-cover rounded-2xl shadow-2xl"
            />
        ...
        {/* Stats */}
        <div className="flex flex-col sm:flex-row items-center sm:items-center justify-between gap-4 sm:gap-8 border-t border-gray-200">
            <div className="w-full flex items-center justify-between py-12 space-x-6">
