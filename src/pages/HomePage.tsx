...
export function HomePage() {
  // track whether the footer is visible (used to hide social icons)
  ...
  useEffect(() => {
    ...
    if (footerEl && 'IntersectionObserver' in window) {
      ...
      // Fallback: simple scroll-based check to detect near-bottom
      const threshold = 150;
      const onScroll = () => {
  ...
  return (
    ...
    <>
      ...
      <div
        className={`fixed right-0 md:right-3 z-50 transition-opacity transition-transform duration-300 ease-in-out flex flex-col gap-4 items-end 
  md:top-1/4 md:-translate-y-1/2 bottom-8 pr-4 
  ${isFooterVisible
            ? 'opacity-0 md:translate-x-4 translate-y-4 pointer-events-none'
          ...
          <div style={{ height: "300px", display: "flex", flexDirection: "column", justifyContent: "space-evenly", alignItems: "flex-end" }}>
            ...
            <a href="https://www.facebook.com/" target="_blank" rel="noopener noreferrer" className="transform hover:scale-135 will-change-transform transition duration-200">
              <svg width="48" height="48" viewBox="0 0 48 48">
                <path fill="#039be5" d="M24,4C12.954,4,4,12.954,4,24s8.954,20,20,20s20-8.954,20-20S35.046,4,24,4z" />
                <path fill="#fff" d="M26.572,29.036h4.917l0.772-4.995h-5.69v-2.73c0-2.075,0.678-3.915,2.619-3.915h3.119v-4.359c-0.548-0.074-1.707-0.236-3.897-0.236c-4.573,0-7.254,2.415-7.254,7.917v3.323h-4.701v4.995h4.701v13.729C22.089,42.905,23.032,43,24,43c0.875,0,1.729-0.08,2.572-0.194V29.036z" />
              </svg>
            </a>
            <a href="https://x.com" target="_blank" rel="noopener noreferrer" className="transform hover:scale-135 will-change-transform transition duration-200">
              <svg xmlns="ht 
      tp://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 50 50">
                <path d="M 11 4 C 7.134 4 4 7.134 4 11 L 4 39 C 4 42.866 7.134 46 11 46 L 39 46 C 42.866 46 46 42.866 46 39 L 46 11 C 46 7.134 42.866 4 39 4 L 11 4 z M 13.085938 13 L 21.023438 13 L 26.660156 21.009766 L 33.5 13 L 36 13 L 27.789062 22.613281 L 37.914062 37 L 29.978516 37 L 23.4375 27.707031 L 15.5 37 L 13 37 L 22.308594 26.103516 L 13.085938 13 z M 16.914062 15 L 31.021484 35 L 34.085938 35 L 19.978516 15 L 16.914062 15 z"></path>
              </svg>
            </a>
            <a href="https://instagram.com" target="_blank" rel="noopener noreferrer" className="transform hover:scale-135 will-change-transform transition duration-200">
              <svg width="48" height="48" viewBox="0 0 48 48">
            ...
            <a href="https://linkedin.com" target="_blank" rel="noopener noreferrer" className="transform hover:scale-135 will-change-transform transition duration-200">
              <svg width="48" height="48" viewBox="0 0 48 48">
                <path fill="#0288D1" d="M42,37c0,2.762-2.238,5-5,5H11c-2.761,0-5-2.238-5-5V11c0-2.762,2.239-5,5-5h26c2.762,0,5,2.238,5,5V37z"></path>
                <path fill="#FFF" d="M12 19H17V36H12zM14.485 17h-.028C12.965 17 12 15.888 12 14.499 12 13.08 12.995 12 14.514 12c1.521 0 2.458 1.08 2.486 2.499C17 15.887 16.035 17 14.485 17zM36 36h-5v-9.099c0-2.198-1.225-3.698-3.192-3.698-1.501 0-2.313 1.012-2.707 1.99C24.957 25.543 25 26.511 25 27v9h-5V19h5v2.616C25.721 20.5 26.85 19 29.738 19c3.578 0 6.261 2.25 6.261 7.274L36 36 36 36z"></path>
              </svg>
            </a>
            <a href="https://youtube.com" target="_blank" rel="noopener noreferrer" className="transform hover:scale-135 will-change-transform transition duration-200">
          ...
          <div className="flex flex-row gap-4 items-center">
            <a
              ...
              className="transform md:scale-100 scale-75 transition duration-200 hover:scale-110"
            ...
            <a href="tel:+919812345678" className="transform md:scale-100 scale-75 transition duration-200 hover:scale-110" aria-label="Phone" style={{ willChange: "transform" }}>
              <svg width="48" height="48" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
                <circle cx="24" cy="24" r="24" fill="#0059ffff" />
                <path d="M34.2 31.7l-4.2-1c-.6-.1-1.2 0-1.6.4l-1.8 1.8c-3.2-1.7-5.8-4.3-7.5-7.5l1.8-1.8c.4-.4.5-1 .4-1.6l-1-4.2c-.2-.7-.8-1.2-1.5-1.2h-3.2c-.8 0-1.5.7-1.5 1.5 0 10.5 8.5 19 19 19 .8 0 1.5-.7 1.5-1.5v-3.2c0-.7-.5-1.3-1.2-1.5z" fill="#fff" />
              </svg>
            </a>
